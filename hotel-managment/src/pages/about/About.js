  ...
  return (
    ...
    <div className="about-container">
      ...
      <p className="about-description">
        Welcome to [Restaurant Name]! We are dedicated to serving you the best food with the freshest ingredients.
        Our mission is to provide a memorable dining experience that combines excellent service, delicious meals, and a warm atmosphere.
      </p>
      <h2>Our Mission</h2>
      <p>
...
const teamMembers = [
  {
    ...
    name: 'John Doe',
    position: 'Head Chef',
    image: require('../../images/t6.jpeg'),
  },{
    id: 1,
    name: 'John Doe',
    position: 'Head Chef',
    image: require('../../images/t5.jpeg'),
  },
  {
    id: 1,
    name: 'John Doe',
    position: 'Head Chef',
    image: require('../../images/t4.jpeg'),
  },
  {
    id: 1,
    name: 'John Doe',
    position: 'Head Chef',
    image: require('../../images/t3.jpeg'),
  },
  {
    id: 2,
    name: 'Jane Smith',
    position: 'Manager',
    image: require('../../images/t2.jpeg'),
  },
  {
    id: 3,
    name: 'Emily Johnson',
    position: 'Sous Chef',
    image: require('../../images/t1.jpeg'),
  },
];
...
const galleryImages = [
  require('../../images/t5.jpeg'),
  require('../../images/t4.jpeg'),
  require('../../images/t3.jpeg'),
  require('../../images/t2.jpeg'),
   require('../../images/t1.jpeg'),
];
